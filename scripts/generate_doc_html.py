...
<body>
    ...
    <div class="notice">
        ...
        1. เปิดไฟล์นี้ in เว็บเบราว์เซอร์ของคุณ (เช่น Google Chrome)<br>
    ...
    <p class="caption">รูปที่ 4.1: แผนภาพแสดงความสัมพันธ์ของฐานข้อมูล (ER Diagram)</p>
